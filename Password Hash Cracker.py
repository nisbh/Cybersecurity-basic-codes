...
# The path to the file containing potential passwords, one per line.
# You will need to create this file, named 'wordlist.txt', in the same directory.
# Add some words to it, like 'hello', 'world', '12345', 'password123'.
